...
const Page = () => {
  ...
  return (
    <div className="flex w-full h-screen bg-gray-50 dark:bg-black">
      <div className="w-full bg-gray-50 dark:bg-black overflow-y-auto p-2 sm:p-4">
        {/* Friend Requests Section */}
        <div className="bg-white dark:bg-[#0d0d0d] dark:text-white rounded-lg shadow-sm p-3 sm:p-4 mb-4 sm:mb-6">
          <h2 className="text-base sm:text-lg font-semibold dark:text-white text-gray-900 mb-3 flex items-center">
            <UserPlus className="h-4 w-4 sm:h-5 sm:w-5 mr-1 sm:mr-2 text-blue-500" />
          ...
          {friendRequests?.requests.length > 0 ? (
            <div className="space-y-3">
              {friendRequests.requests.map((request: RequestProps) => (
                <div
                  key={request._id}
                  className="flex items-center justify-between p-2 sm:p-4 bg-gray-50 dark:bg-transparent rounded-lg"
                >
                  <div className="flex items-center">
                    ...
                    <div className="ml-2 sm:ml-4">
                      <h3 className="text-sm sm:text-base font-medium dark:text-white text-gray-900">
            ...
            <div className="flex text-sm sm:text-xl font-semibold justify-center h-[200px] sm:h-[350px] items-center w-full">
            ...
            <div className="space-y-3">
              {sentFriendRequests.requests.map((request: any) => (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row justify-center text-xs items-end sm:items-center gap-1 sm:gap-2">
                    {request?.status === "pending" &&
                      <div
                        onClick={() => cancelFriendRequest(request._id)}
                        className="border p-1 px-3 sm:p-2 sm:px-5 rounded-xl cursor-pointer text-xs"
                      >
                        Cancel
                      </div>
                    }
                    <div className={`p-1 px-3 sm:p-2 sm:px-5 text-white rounded-xl text-xs ${request?.status === "rejected" ? "bg-red-700" :
        ...
        {/* Suggestions Section */}
        <div className="bg-white mb-16 dark:bg-[#0d0d0d] dark:text-white rounded-lg shadow-sm p-3 sm:p-4 sm:mb-6">
          <h2 className="text-base sm:text-lg font-semibold dark:text-white text-gray-900 mb-3 flex items-center">
            <UserPlus className="h-4 w-4 sm:h-5 sm:w-5 mr-1 sm:mr-2 text-blue-500" />
            Suggestions
          </h2>
              ...
              {suggestedUsers.users.map((user: User) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-6 h-6 sm:w-8 sm:h-8 bg-blue-500 rounded-full text-white justify-center hover:bg-blue-600 flex items-center transition-colors"
